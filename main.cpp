...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "seci-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.seci.io", ""};
static const string testnet_seeds[] = {"dnsseed.seci.io", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("null.onion", 9819), true);
  }
  do {
